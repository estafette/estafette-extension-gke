...
func sendNotifications(status string) {
	...
	var webhookURL = "https://hooks.slack.com/services/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"
	var channels [1]string

	for i := range channels {
		err := SendSlackNotification(channels[i], "To many errors!", message, status, webhookURL)
		log.Fatal(err)
