...
func (p *Params) initializeSidecarDefaults(sidecar *SidecarParams) {
	...
	case "openresty":
		if sidecar.Image == "" {
			sidecar.Image = "estafette/openresty-sidecar@sha256:6f4ddb92882349c8a3058b21fc2d75f246e7ce68a470c5533da3b205fd6381e4"
		}
	...
	case "cloudsqlproxy":
		if sidecar.Image == "" {
			sidecar.Image = "eu.gcr.io/cloudsql-docker/gce-proxy:1.16"
		}
	}
